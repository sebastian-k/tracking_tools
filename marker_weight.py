...
class CLIP_OT_WeightFade(Operator):
    ...
    fade_time = bpy.props.IntProperty(name="Fade Time", default=10, min=0, max=100)
...
classes = (CLIP_OT_WeightFade, CLIP_OT_SelectZeroWeightedTracks, CLIP_PT_WeightFadePanel)
